...
import { InformationCircleIcon as InformationCircle, CheckIcon as Check } from '@heroicons/react/24/solid/index.js';
            ...
            <div>
              <div className="flex items-center gap-2 mb-2">
                ...
                <div className="group relative">
                  <InformationCircle className="w-4 h-4 text-gray-400 cursor-help" />
